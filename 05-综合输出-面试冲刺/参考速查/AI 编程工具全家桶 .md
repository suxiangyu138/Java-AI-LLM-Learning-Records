...
| 项目 | 值 |
|------|-----|
| API Key | `sk-f9f5ad1f23ef4eacbe413eddd9c82536` |
...
agents.set_default_openai_client(AsyncOpenAI(
    api_key="sk-f9f5ad1f23ef4eacbe413eddd9c82536",
...
model = init_chat_model(
    "deepseek-chat",
    openai_api_key="sk-f9f5ad1f23ef4eacbe413eddd9c82536",
...
```python
import os
os.environ["OPENAI_API_KEY"] = "sk-f9f5ad1f23ef4eacbe413eddd9c82536"
...
| 项目 | 值 |
|------|-----|
| 环境变量 | `DEEPSEEK_API_KEY=sk-f9f5ad1f23ef4eacbe413eddd9c82536` |
| Base URL | `https://api.deepseek.com` |
