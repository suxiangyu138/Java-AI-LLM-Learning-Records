...
|:---:|------|------|:---:|------|:---:|
| 206 | 反转链表 | 反转 | 🟢 | 三指针/递归，母题 | [02-反转系列](04-反转链表系列.md) |
| 92 | 反转链表 II | 反转 | 🟡 | 头插法反转区间 | [02-反转系列](04-反转链表系列.md) |
| 24 | 两两交换 | 反转 | 🟡 | dummy + 三指针 | [02-反转系列](04-反转链表系列.md) |
| 25 | K 个一组翻转 | 反转 | 🔴 | 区间反转 + 拼接 | [02-反转系列](04-反转链表系列.md) |
| 141 | 环形链表 | 快慢指针 | 🟢 | Floyd 判圈 | [03-环形快慢](05-环形与快慢指针.md) |
| 142 | 环形链表 II | 快慢指针 | 🟡 | 重置 slow 找入口 | [03-环形快慢](05-环形与快慢指针.md) |
| 876 | 链表中点 | 快慢指针 | 🟢 | 快 2 慢 1 | [03-环形快慢](05-环形与快慢指针.md) |
| 19 | 删除倒数第 N | 快慢指针 | 🟡 | fast 先走 N+1 | [03-环形快慢](05-环形与快慢指针.md) |
| 160 | 相交链表 | 快慢指针 | 🟢 | 走完跳对方 | [03-环形快慢](05-环形与快慢指针.md) |
| 234 | 回文链表 | 综合 | 🟢 | 中点+反转+比较 | [03-环形快慢](05-环形与快慢指针.md) |
| 21 | 合并两有序链 | 合并 | 🟢 | 双指针 + dummy | [04-合并排序](06-合并与排序链表.md) |
| 23 | 合并 K 链 | 合并 | 🔴 | 优先队列 | [04-合并排序](06-合并与排序链表.md) |
| 148 | 排序链表 | 排序 | 🟡 | 归并 + 快慢指针 | [04-合并排序](06-合并与排序链表.md) |
| 86 | 分隔链表 | 操作 | 🟡 | 双 dummy + 断环 | [04-合并排序](06-合并与排序链表.md) |
| 82 | 删除重复 II | 操作 | 🟡 | 跳过重复区间 | [04-合并排序](06-合并与排序链表.md) |
| 2 | 两数相加 | 操作 | 🟡 | 进位 + 双指针 | — |
| 61 | 旋转链表 | 操作 | 🟡 | 首尾相连 + 断链 | — |
