...
> **文档版本：** v1.0 | **最后更新：** 2026-06-13 | **优先级：** ★★★☆☆（后端拓展）
>
...
h 的选择：
  ...
  最优 h ≈ ε^{1/2}（单精度）或 ε^{1/3}（双精度），ε 是机器精度
```
...
- [[01-线性代数-核心知识与AI应用]] —— 线性方程组的矩阵解法
- [[02-微积分-核心知识与AI应用]] —— 数值微分的理论基础
- [[03-概率论与数理统计-核心知识与AI应用]] —— 数值积分在概率中的应用
- [[00-数学基础总览]] —— 返回总览
