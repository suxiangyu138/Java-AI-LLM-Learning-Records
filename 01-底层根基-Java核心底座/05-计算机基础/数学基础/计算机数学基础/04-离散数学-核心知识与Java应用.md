...
<!-- v2.0, updated 2026-06-13, priority ★★★★☆ -->
...
| 最小生成树 | Prim | `O((V+E)logV)`（堆优化）/ `O(V²)`（稠密） | 稠密图用 O(V²) 版 |
...
- [01-线性代数-核心知识与AI应用](./01-线性代数-核心知识与AI应用.md) —— 图的邻接矩阵表示
- [09-组合数学核心知识点](./09-组合数学核心知识点.md) —— 排列组合与递推（含卡特兰数）
