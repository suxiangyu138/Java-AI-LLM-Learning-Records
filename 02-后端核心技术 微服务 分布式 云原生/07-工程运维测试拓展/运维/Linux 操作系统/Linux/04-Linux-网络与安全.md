...
### 3.1 firewalld（RHEL 8+ / Rocky & Alma 10 默认防火墙）
...
### 3.3 nftables（新一代，RHEL 9+/10 默认后端）

nftables 是 iptables 的现代替代：统一 IPv4/IPv6 语法、原子规则替换、性能更好。**RHEL 9+ 起内核防火墙后端已切换为 nftables**（firewalld 底层、iptables 命令均为其封装），RHEL 10 延续该架构——新系统上直接学 nft 语法即可，iptables 仅存量系统需要。
...
**上一模块**：[03-Linux 系统管理](03-Linux-系统管理.md) ｜ **下一模块**：[05-Linux 服务管理](05-Linux-服务管理.md) ｜ **返回总览**：[00-知识体系总览](00-Linux知识体系总览.md)

**【参考来源】**
- firewalld 官方文档：https://firewalld.org/\n- Red Hat 安全指南：https://docs.redhat.com/en/documentation/red_hat_enterprise_linux/
