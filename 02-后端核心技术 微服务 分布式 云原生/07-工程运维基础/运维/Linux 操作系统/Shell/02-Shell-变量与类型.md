...
**上一模块**：[01-Shell 入门](01-Shell-入门.md) ｜ **下一模块**：[03-Shell 流程控制](03-Shell-流程控制.md) ｜ **返回总览**：[00-知识体系总览](00-Shell知识体系总览.md)

**【参考来源】**
- Bash 官方手册（参数展开）：https://www.gnu.org/software/bash/manual/html_node/Shell-Parameter-Expansion.html\n- Bash 关联数组：`man bash` → ARRAYS 章节
