...
1. [正则表达式：BRE 与 ERE](#1-正则表达式bre-与-ere)
2. [grep 文本搜索](#2-grep-文本搜索)
3. [sed 流编辑器](#3-sed-流编辑器)
4. [awk 字段处理与计算](#4-awk-字段处理与计算)
5. [cut / sort / uniq / wc](#5-cutsortuniqwc)
6. [文本处理流水线（pipeline）](#6-文本处理流水线pipeline)
7. [文件重定向与管道](#7-文件重定向与管道)
...
**上一模块**：[04-Shell 函数与实战](04-Shell-函数与实战.md) ｜ **关联体系**：[Linux 知识体系总览](../Linux/00-Linux知识体系总览.md) ｜ **返回总览**：[00-知识体系总览](00-Shell知识体系总览.md)

**【参考来源】**
- GNU grep/sed/awk 手册：https://www.gnu.org/software/grep/ https://www.gnu.org/software/sed/ https://www.gnu.org/software/gawk/\n- 正则基础：`man 7 regex`
