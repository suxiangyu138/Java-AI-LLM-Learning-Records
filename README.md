...
> **2,923 篇标准化 Markdown 技术文档**，按 5 层金字塔组织，覆盖从底层基础到面试冲刺的完整学习路径。
...
```
Java-AI-LLM-Learning-Records/  (2,923 篇 .md 文件)
│
├── 🏗️ 01-底层根基-Java核心底座/        1023 篇  地基：Java核心+JUC+JVM+DSA+计算机基础(四大件+数学体系)+工具(Vim/文件后缀/SDK)
│
├── 🔧 02-后端核心技术 微服务 分布式 云原生/ 698 篇  骨架：MySQL+Redis+MQ+ES+Spring全家桶+MyBatisPlus+DevOps
│
...
```text
新增 114 篇技术文档，覆盖 14 个知识体系（计算机组成原理四大件 + 数学基础四套 + JMM + MQ 理论 + SQLite + Memcached + Neo4j + 存量修正）：
...
*最后更新：2026-08-06 | 2,923 篇 Markdown 文档 | 5 层金字塔 + 28 个活跃知识体系*
