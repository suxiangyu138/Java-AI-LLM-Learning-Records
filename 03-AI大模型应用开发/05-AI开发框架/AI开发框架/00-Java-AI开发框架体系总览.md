...
│
├── 🏗️ 项目实战篇（12-14）🆕
│   ├── 12-SpringAI项目实战-RAG问答系统.md  # 完整项目：配置/代码/目录/部署
│   ├── 13-LangChain4j项目实战-Agent系统.md  # 完整项目：接口/Agent/工具/记忆/流式
│   └── 14-生产级AI架构设计与运维.md         # 多模型路由/降级/监控/限流/Docker
│
...
| 11 | 面试题与选型 | 20题+选型矩阵 | ⭐⭐⭐ |
| 12 | **SpringAI RAG 项目实战 🆕** | 完整项目：pom/配置/代码/目录/部署 | ⭐⭐⭐⭐ |
| 13 | **LangChain4j Agent 项目实战 🆕** | 完整项目：接口/Agent/工具/记忆/流式 | ⭐⭐⭐⭐ |
| 14 | **生产级AI架构设计 🆕** | 多模型路由/降级/监控/限流/Docker | ⭐⭐⭐⭐ |
